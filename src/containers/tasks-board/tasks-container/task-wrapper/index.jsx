  ...
  return (
    <div className=" border-b-2 border-dashed border-zinc-200 bg-white  p-3 text-zinc-700">
      ...
      <div className="flex justify-between">
        ...
        <div onBlur={()=>setShowMenu(false)} className={classNames("absolute right-0 border bg-white text-xs transition-all font-medium rounded-lg",{
          "opacity-0 pointer-events-none":!showMenu
        })}>
          <p onClick={()=>openEditPanel()} className=" py-2 border-b hover:bg-zinc-300 px-6 cursor-pointer">Edit</p>
